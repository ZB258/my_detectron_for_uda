...
register_coco_instances("dataset_train_source", {}, "/home/jin/1_projects/detectron2/datasets/SAR-Ship-Detection/annotations/SAR-Ship-Dataset_coco_format.json", "/home/jin/1_projects/detectron2/datasets/SAR-Ship-Detection/images")
register_coco_instances("dataset_train_target", {}, "/home/jin/1_projects/detectron2/datasets/SARscope/annotations/train_annotations.coco.json", "/home/jin/1_projects/detectron2/datasets/SARscope/train")

register_coco_instances("dataset_test_target", {}, "/home/jin/1_projects/detectron2/datasets/SARscope/annotations/test_annotations.coco.json", "/home/jin/1_projects/detectron2/datasets/SARscope/test")
...
cfg_source.DATASETS.TRAIN = ("dataset_train_source",)
...
cfg_source.SOLVER.MAX_ITER = 3000 #############################################################################
...
cfg_target = get_cfg()
cfg_target.DATASETS.TRAIN = ("dataset_train_target",)
...
evaluator = COCOEvaluator("dataset_test_target", cfg_source, False, output_dir="./output/")
val_loader = build_detection_test_loader(cfg_source, "dataset_test_target")
